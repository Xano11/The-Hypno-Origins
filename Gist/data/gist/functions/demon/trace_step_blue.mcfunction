#particle
particle minecraft:soul_fire_flame ~ ~ ~ 0.05 0.05 0.05 10000 1 force @a[distance=..30]
particle minecraft:soul_fire_flame ~ ~ ~ 0.05 0.05 0.05 10000 1 normal @a[distance=..30]
...
execute if score #count def.gist.id matches ..120 as @s at @s if entity @e[type=marker,tag=def.gist.playerMarker,distance=0.3..] run function gist:demon/trace_step_blue